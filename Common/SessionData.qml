...
Singleton {
    ...
    property string nightModeAutoMode: "manual" // "manual", "time", "location"
    property string nightModeStartTime: "20:00" // HH:mm format
    property string nightModeEndTime: "06:00" // HH:mm format
